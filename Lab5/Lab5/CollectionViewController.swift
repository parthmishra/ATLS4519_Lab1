...
//  Lab5
//
//  Created by Parth Mishra on 2/11/16.
...
class CollectionViewController: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    ...
    */
    ...
    override func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
        ...
        // Configure the cell
        let image = UIImage(named: clothesImages[indexPath.row])
    ...
    override func collectionView(collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, atIndexPath indexPath: NSIndexPath) -> UICollectionReusableView {
        ...
        if kind == UICollectionElementKindSectionHeader{
            ...
            header?.headerLabel.text = "Top Selections"
        }
        return header!
    }
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        if segue.identifier == "showDetail" {
            ...
            detailVC.imageName = clothesImages[(indexPath?.row)!]
        }
    }
    ...
    override func collectionView(collectionView: UICollectionView, shouldSelectItemAtIndexPath indexPath: NSIndexPath) -> Bool {
        if sharing {
            let image = clothesImages[indexPath.row]
            if let foundIndex = selectedImages.indexOf(clothesImages[indexPath.row]) {
                //deselect and remove
